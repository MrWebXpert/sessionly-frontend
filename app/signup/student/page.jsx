...
const SignupForm = () => {
    ...
    const handleSubmitSignUp = async (e) => {
        ...
        try {
            const response = await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/v2/student/register`, formData);
                                            ...
                                            >
                                                ...
                                                <div className="relative mt-10">
                                                    <input
                                                        ...
                                                        className="w-full bg-transparent border-none outline-none placeholder-italic focus:outline-none"
                                                    />
                                                </div>
